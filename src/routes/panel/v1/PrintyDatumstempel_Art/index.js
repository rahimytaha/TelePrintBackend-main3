...
const Controller = require("../../../../controller/panel/v1/PrintyDatumstempel_Art");
...
router.delete(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.deletePrintyDatumstempel_Art.bind(Controller),
);
...
router.put(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.updatePrintyDatumstempel_Art.bind(Controller),
);
