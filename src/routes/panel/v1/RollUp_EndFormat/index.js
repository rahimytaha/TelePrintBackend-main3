...
const Controller = require("../../../../controller/panel/v1/RollUp_EndFormat");
...
router.delete(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.deleteRollUp_EndFormat.bind(Controller),
);
...
router.put(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.updateRollUp_EndFormat.bind(Controller),
);
