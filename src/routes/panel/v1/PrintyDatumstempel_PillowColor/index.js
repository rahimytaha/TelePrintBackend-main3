...
const Controller = require("../../../../controller/panel/v1/PrintyDatumstempel_PillowColors");
...
router.delete(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.deletePrintyDatumstempel_PillowColors.bind(Controller),
);
...
router.put(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.updatePrintyDatumstempel_PillowColors.bind(Controller),
);
