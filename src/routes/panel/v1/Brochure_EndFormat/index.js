...
const Controller = require("../../../../controller/panel/v1/Brochure_EndFormat")
...
router.delete(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.deleteBrochure_EndFormat.bind(Controller)
)
...
router.put(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.updateBrochure_EndFormat.bind(Controller)
)
