...
const Controller = require("../../../../controller/panel/v1/Poster_Material");
...
router.delete(
  ...
  AdminToken,
  Controller.deletePoster_Material.bind(Controller)
);
...
router.put(
  ...
  AdminToken,
  Controller.updatePoster_Material.bind(Controller)
);
