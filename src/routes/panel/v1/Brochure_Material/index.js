...
const Controller = require("../../../../controller/panel/v1/Brochure_Material")
...
router.delete(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.deleteBrochure_Material.bind(Controller)
)
...
router.put(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.updateBrochure_Material.bind(Controller)
)
