...
const Controller = require("../../../../controller/panel/v1/Poster_EndFormat");
...
router.delete(
  ...
  AdminToken,
  Controller.deletePoster_EndFormat.bind(Controller)
);
...
router.put(
  ...
  AdminToken,
  Controller.updatePoster_EndFormat.bind(Controller)
);
