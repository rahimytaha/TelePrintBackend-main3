...
const Controller = require("../../../../controller/panel/v1/Visitenkarte_Standard_EndFormat");
...
router.delete(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.deleteVisitenkarte_Standard_EndFormat.bind(Controller),
);
...
router.put(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.updateVisitenkarte_Standard_EndFormat.bind(Controller),
);
