...
const Controller = require("../../../../controller/panel/v1/RollUp_Material");
...
router.delete(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.deleteRollUp_Material.bind(Controller),
);
...
router.put(
  ...
  InputValidation([param("id").notEmpty().withMessage("حتماً باید یک شناسه وارد کنید.")]),
  AdminToken,
  Controller.updateRollUp_Material.bind(Controller),
);
