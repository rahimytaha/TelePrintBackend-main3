...
const Model = require("../../model/v1/FolderWickelfalz6seiten_Record")

module.exports = new (class serviceModel extends BaseService {
  async calculatorPrice(req, Material) {
    const { count, width, height, doubleSided, colorful, isCellophane } = req
    ...
    const lastPrice = FinalResult + foldPrice
